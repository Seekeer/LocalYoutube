...
namespace FileStore.API.Configuration
{
    ...
    public class StartupInitService : IStartupInitService
    {
        ...
        {
            _DbUpdateManager.AddOrUpdateVideoSeries(SeasonNames.OneTime, false, Domain.Models.VideoType.Web);
            _DbUpdateManager.AddOrUpdateVideoSeries(SeasonNames.India, false, Domain.Models.VideoType.Web);
        }
    }
}