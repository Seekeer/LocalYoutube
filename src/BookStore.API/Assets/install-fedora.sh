...
# Fedora Installation Script for BookStore Linux Dependencies
# This script installs all required dependencies for the BookStore application on Fedora systems

set -e  # Exit on any error

echo "BookStore Linux Dependencies Installer for Fedora"
echo "================================================="
...
if is_root; then
    dnf install -y ffmpeg wget curl
else
    sudo dnf install -y ffmpeg wget curl
fi
