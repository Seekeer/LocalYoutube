    ...
    public class CategoriesControllerTests
    {
        ...
        public async void GetAll_ShouldReturnOk_WhenExistCategory()
        {
            ...
            _mapperMock.Setup(m => m.Map<IEnumerable<CategoryResultDto>>(
                It.IsAny<List<Season>>())).Returns(dtoExpected);
        ...
        {
            var categories = new List<Season>();
            var dtoExpected = MapModelToCategoryListDto(categories);

            _categoryServiceMock.Setup(c => c.GetAll()).ReturnsAsync(categories);
            _mapperMock.Setup(m => m.Map<IEnumerable<CategoryResultDto>>(It.IsAny<List<Season>>())).Returns(dtoExpected);
        ...
        public async void GetById_ShouldReturnOk_WhenCategoryExist()
        {
            ...
            _mapperMock.Setup(m => m.Map<CategoryResultDto>(It.IsAny<Season>())).Returns(dtoExpected);
        ...
        {
            _categoryServiceMock.Setup(c => c.GetById(2)).ReturnsAsync((Season)null);
        ...
        public async void Add_ShouldReturnOk_WhenCategoryIsAdded()
        {
            ...
            _mapperMock.Setup(m => m.Map<Season>(It.IsAny<CategoryAddDto>())).Returns(category);
            _categoryServiceMock.Setup(c => c.Add(category)).ReturnsAsync(category);
            _mapperMock.Setup(m => m.Map<CategoryResultDto>(It.IsAny<Season>())).Returns(categoryResultDto);
        ...
        public async void Add_ShouldReturnBadRequest_WhenCategoryResultIsNull()
        {
            ...
            _mapperMock.Setup(m => m.Map<Season>(It.IsAny<CategoryAddDto>())).Returns(category);
            _categoryServiceMock.Setup(c => c.Add(category)).ReturnsAsync((Season)null);
        ...
        public async void Update_ShouldReturnOk_WhenCategoryIsUpdatedCorrectly()
        {
            ...
            _mapperMock.Setup(m => m.Map<Season>(It.IsAny<CategoryEditDto>())).Returns(category);
        ...
        {
            var category = CreateCategory();
            _categoryServiceMock.Setup(c => c.GetById(category.Id)).ReturnsAsync((Season)null);
        ...
        public async void Search_ShouldReturnOk_WhenCategoryWithSearchedNameExist()
        {
            ...
            _mapperMock.Setup(m => m.Map<List<Season>>(It.IsAny<IEnumerable<Season>>())).Returns(categoryList);
        ...
        {
            var category = CreateCategory();
            var categoryList = new List<Season>();
            ...
            _categoryServiceMock.Setup(c => c.Search(category.Name))
                .ReturnsAsync(categoryList);
            _mapperMock.Setup(m => m.Map<IEnumerable<Season>>(It.IsAny<Season>())).Returns(categoryList);
        ...
        private CategoryResultDto MapModelToCategoryResultDto(Season category)
        {
        ...
        private List<CategoryResultDto> MapModelToCategoryListDto(List<Season> categories)
        {
